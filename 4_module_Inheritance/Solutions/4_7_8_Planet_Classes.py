...
В объектах этого класса должны быть допустимы,
...
https://stepik.org/lesson/702001/step/8?unit=702102
"""
...
if __name__ == '__main__':
    ...
    # Далее - для проверки:
    s_system.a = 8
    sol_syst_1 = SolarSystem()
    sol_syst_2 = SolarSystem()
    print(s_system, sol_syst_1, sol_syst_2)
