...
https://stepik.org/lesson/701996/step/6?unit=702097
"""
...
def lst_cmprhnsion_isinstance(lst, cls_name):
    return [obj for obj in lst if isinstance(obj, cls_name)]
...
lst_animals = lst_cmprhnsion_isinstance(lst=lst_objs, cls_name=Animals)
lst_plants = lst_cmprhnsion_isinstance(lst=lst_objs, cls_name=Plants)
lst_mammals = lst_cmprhnsion_isinstance(lst=lst_objs, cls_name=Mammals)


if __name__ == '__main__':
    print('Animals:')
    print(*lst_animals, sep="\n")
    print('Plants:')
    print(*lst_plants, sep="\n")
    print('Mammals:')
    print(*lst_mammals, sep="\n")
